          ...
          <div className="col-xl-6">
            <div className="about-two__content">
              ...
              <div className="about-two__content-text">
                <p>
                  We are a dispatching company that specializes in providing
                  efficient and reliable transportation services. With our
                  dedicated team and advanced technology, we ensure timely
                  deliveries and exceptional customer satisfaction. Whether it's
                  local or long-distance transportation, we have you covered.
                </p>
              </div>
